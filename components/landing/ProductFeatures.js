...
export default function ProductFeatures(){
    return(
        <div className="flex flex-col items-center justify-center py-12 lg:mx-8 md:first:rounded-t-lg md:last:rounded-b-lg backdrop-blur-lg bg-white dark:bg-black dark:bg-opacity-30 bg-opacity-10 hover:bg-opacity-20 dark:hover:bg-opacity-50 transition border border-gray-800 dark:border-white border-opacity-10 dark:border-opacity-10 border-b-0 last:border-b hover:border-b hovered-sibling:border-t-0">
            ...
            <div className="w-full lg:grid grid-cols-3 gap-5 pt-12">
                <RoughNotation
                    type='box'
                    padding={0}
                >
                    <div className="p-6 flex flex-col lg:flex-row w-full">
                        ...
                        <div>
                                <h5 className="text-2xl py-2 font-bold tracking-tight text-gray-900 dark:text-gray-300">Review</h5>
                ...
                >
                    <div className="p-6 flex flex-col lg:flex-row w-full">
                        ...
                        <div>
                            <h5 className="text-2xl font-bold py-2 tracking-tight text-gray-900 dark:text-gray-300">Rigorous Testing</h5>
                ...
                >
                    <div className="p-6 flex flex-col lg:flex-row w-full">
                        ...
                        <div>
                            <h5 className="text-2xl font-bold py-2 tracking-tight text-gray-900 dark:text-gray-300">Ongoing Support</h5>
